#!/bin/bash
  ...
  # Purpose: Install dotfiles, Guix, SBCL, shl, lish, lem, StumpWM and Emacs
  #
  ...
  # cd git clone https://codeberg.org/nibbula/yew.git
  # cd yew/lish

  # # modify vars.lisp search:path-append
  # # (defun hide-default-lishrc ()
  ...
  # echo "  - GNU Guix:  $(guix --version | head -n1 || echo 'Check PATH')"
  # echo "  - SBCL:      $(sbcl --version)"
  # echo "  - StumpWM:   $(which stumpwm)"
  # echo "  - Emacs:     $(emacs --version | head -n1)"
  # echo "  - Xpra:      $(xpra --version | head -n1)"
